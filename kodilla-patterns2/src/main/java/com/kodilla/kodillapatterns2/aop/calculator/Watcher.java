...
public class Watcher {
    ...
    @Before("execution(* com.kodilla.kodillapatterns2.aop.calculator.Calculator.factrorial(..))" +
    ...
    @Around("execution(* com.kodilla.kodillapatterns2.aop.calculator.Calculator.factrorial(..))")
