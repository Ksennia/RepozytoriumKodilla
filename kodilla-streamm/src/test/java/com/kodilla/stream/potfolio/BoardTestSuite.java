package com.kodilla.stream.potfolio;

import org.junit.Assert;
import org.junit.Test;
import stream.potfolio.Board;
import stream.potfolio.Task;
import stream.potfolio.TaskList;
import stream.potfolio.User;
...
public class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        OptionalDouble averageTime = project.getTaskLists().stream()
                ...
                .map(d -> {
                    return LocalDate.now().getDayOfMonth() - d.getCreated().getDayOfMonth();
                })
                .mapToInt(d -> d)
                .average();
        //then
        Assert.assertEquals(3.0, averageTime);
